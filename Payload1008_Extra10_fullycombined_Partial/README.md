...
## 示意圖
![Architecture](../PNG/Partial_TG.png)
...
- `PCM_P1008_E10_PartialExtraTransmit.txt` : 合併的`PCM`檔案
- `Table_Superposition_Extra_Payload.csv` : `Puncture` 的 `VN Node(fully-combined)` (start idx = 1)
- `Table_ExtraTransmitVNs_to_PuncPosPayload.csv` : `Extra VNs` 傳送出去 對應到 `Payload VNs` 做 `Puncture`
