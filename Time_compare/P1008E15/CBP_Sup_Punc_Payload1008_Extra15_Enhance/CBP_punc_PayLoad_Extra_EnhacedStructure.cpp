...
int main(int argc,char* argv[]){
    ...
    string Superpostion_Payload_Extra_NewStructure_pos_file = argv[12]; // 新的結構 一個被punc過的Extra 會跟 兩個payload bits做結合
    string time_outfile = argv[13];
    cout << "##############################" << "\n";
    ...
    if (!time_out.is_open()) {
        cout << "Output file: " << time_outfile  << " cannot be opened." << endl;
		exit(1);
    }
    time_out << "SNR" << ", " << "time";
    time_out << endl;
